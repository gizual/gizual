...
export function TypePlaceholderModule() {
  ...
  return (
    <DialogProvider
      ...
      title="Choose a render-type"
      triggerClassName={style.SearchModulePlaceholderTrigger}
      isOpen={isOpen}
      setIsOpen={setIsOpen}
    >
    ...
    <div className={clsx(sharedStyle.FlexColumn, sharedStyle["Gap-2"])} ref={ref}>
      ...
      {step === currentStep && (
        <div className={clsx(sharedStyle.FlexRow, sharedStyle["Gap-2"])}>
          {step < maxSteps - 1 && (
            <Button size="regular" onClick={onNext} variant="filled">
              Next
            </Button>
          )}
          {step > 0 && step < maxSteps - 1 && (
            <Button size="regular" onClick={onPrevious} variant="gray">
              Previous
            </Button>
          )}
        </div>
...
export function TypeSelectionGridItem({
  ...
  return (
    <label className={style.TypeDialogGridItem}>
      <input type="radio" name="type" checked={checked} onChange={() => onChange(type)} />
      <div className={style.TypeDialogGridItemTile}>
        <img className={style.TypeDialogGridItemImage} alt={imageAlt} />
